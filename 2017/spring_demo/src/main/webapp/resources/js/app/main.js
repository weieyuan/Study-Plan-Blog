define(function (require, exports, module) {
    ...
    var AppMain = function () {
        ...
        this.init = function (strPanelId) {
            _initHead();
            _initBody1(strPanelId);
            _initBody2(strPanelId);
            _initBody3(strPanelId);
            _initBody4(strPanelId);
        };
        ...
        var _initBody1 = function (strPanelId) {
            var strHtml = '\
        ...
        var _initBody2 = function (strPanelId) {
            var strHtml = '\
        ...
        var _initBody3 = function (strPanelId) {
            var strHtml = '\
